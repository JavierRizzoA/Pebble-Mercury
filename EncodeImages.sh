...
./ImageEncoder/ImageEncoder.py --input img/resources/digital_box1~emery.png --output resources/digital_box1~emery.bin --invert
./ImageEncoder/ImageEncoder.py --input img/resources/digital_box2~emery.png --output resources/digital_box2~emery.bin --invert
./ImageEncoder/ImageEncoder.py --input img/resources/digital_box3~emery.png --output resources/digital_box3~emery.bin --invert
...
./ImageEncoder/ImageEncoder.py --input img/resources/digits_big1~emery.png --output resources/digits_big1~emery.bin --invert
./ImageEncoder/ImageEncoder.py --input img/resources/digits_big2~emery.png --output resources/digits_big2~emery.bin --invert
./ImageEncoder/ImageEncoder.py --input img/resources/digits_big3~emery.png --output resources/digits_big3~emery.bin --invert
...
./ImageEncoder/ImageEncoder.py --input img/resources/digital_colon1~emery.png --output resources/digital_colon1~emery.bin --invert
